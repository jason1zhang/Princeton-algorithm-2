...
public class WordNet {
    ...
    private SAP sap;                                    // store sap as the member variable instead of constructing it in the function distance() and sap() to speed up significantly,
                                                        // which improved the score from 94/100 to 99/100
